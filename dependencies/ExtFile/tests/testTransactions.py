...
class TestExtFileUndo(ExtFileTestCase):
    ...
    def testCutPaste(self):
        ...
        self.subfolder.manage_pasteObjects(cb)
        self.failUnless(self._exists('file.exe.undo'))
        self.failUnless(self._exists('file.1.exe.tmp'))
        # Simulate disaster
        self.file._abort()
        self.failUnless(self._exists('file.exe.undo'))
        self.failIf(self._exists('file.1.exe.undo'))
    ...
    def testCutPasteSyncZodb(self):
        ...
        self.file._finish()
        transaction.savepoint(1)
        self.failUnless(self._exists(self.folder_path+'/file.exe'))
        self.failIf(self._exists(self.folder_path+'/file.exe.undo'))
        cb = self.folder.manage_cutObjects(['file'])
        self.subfolder.manage_pasteObjects(cb)
        self.failUnless(self._exists(self.folder_path+'/file.exe.undo'))
        self.failUnless(self._exists(self.subfolder_path+'/file.exe.tmp'))
        # Simulate disaster
        self.file._abort()
        self.failUnless(self._exists(self.folder_path+'/file.exe.undo'))
        self.failIf(self._exists(self.subfolder_path+'/file.exe.undo'))
    ...
    def testRename(self):
        ...
        self.failUnless(self._exists('file.exe.undo'))
        self.failUnless(self._exists('file44.exe.tmp'))
        # Simulate disaster
        self.file._abort()
        self.failUnless(self._exists('file.exe.undo'))
        self.failIf(self._exists('file44.exe.undo'))
    ...
    def testRenameSyncZodb(self):
        ...
        self.folder.manage_renameObject('file', 'file44')
        self.failUnless(self._exists(self.folder_path+'/file.exe.undo'))
        self.failUnless(self._exists(self.folder_path+'/file44.exe.tmp'))
        # Simulate disaster
        self.file._abort()
        self.failUnless(self._exists(self.folder_path+'/file.exe.undo'))
        self.failIf(self._exists(self.folder_path+'/file44.exe.undo'))
...
class TestExtImageUndo(ExtFileTestCase):
    ...
    def testCutPaste(self):
        ...
        self.subfolder.manage_pasteObjects(cb)
        self.failUnless(self._exists('image.1.gif.tmp'))
        self.failUnless(self._exists('image.1.jpg.tmp'))
    ...
    def testCutPasteSyncZodb(self):
        ...
        cb = self.folder.manage_cutObjects(['image'])
        self.subfolder.manage_pasteObjects(cb)
        self.failUnless(self._exists(self.subfolder_path+'/image.gif.tmp'))
        self.failUnless(self._exists(self.subfolder_path+'/image.jpg.tmp'))
    ...
    def testRename(self):
        ...
        self.failUnless(self._exists('image.gif.undo'))
        self.failUnless(self._exists('image.jpg.undo'))
        self.failUnless(self._exists('image44.gif.tmp'))
        self.failUnless(self._exists('image44.jpg.tmp'))
        # Simulate disaster
        self.image._abort()
        self.failUnless(self._exists('image.gif.undo'))
        self.failUnless(self._exists('image.jpg.undo'))
        self.failIf(self._exists('image44.gif.undo'))
        self.failIf(self._exists('image44.jpg.undo'))
    ...
    def testRenameSyncZodb(self):
        ...
        self.failUnless(self._exists(self.folder_path+'/image.gif.undo'))
        self.failUnless(self._exists(self.folder_path+'/image.jpg.undo'))
        self.failUnless(self._exists(self.folder_path+'/image44.gif.tmp'))
        self.failUnless(self._exists(self.folder_path+'/image44.jpg.tmp'))
        # Simulate disaster
        self.image._abort()
        self.failUnless(self._exists(self.folder_path+'/image.gif.undo'))
        self.failUnless(self._exists(self.folder_path+'/image.jpg.undo'))
        self.failIf(self._exists(self.folder_path+'/image44.gif.undo'))
        self.failIf(self._exists(self.folder_path+'/image44.jpg.undo'))
